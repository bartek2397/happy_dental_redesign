  ...
  return (
    <section id="home" className="bg-background max-w-full h-[86vh]">
      <div className="max-w-[1440px] m-auto h-full relative px-4">
        ...
        <div className="absolute p-6 right-[50%] sm:bottom-10 sm:right-5 translate-x-[50%] sm:translate-x-0 mt-[5%] rounded-[50px] bg-[#E4EEE3] text-lg hover:bg-[#C5D8DF] transition">
